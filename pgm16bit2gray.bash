...
echo "set cblabel 'Contribution per pixel %'" >> toto.gplot
echo "unset key" >> toto.gplot
echo "set palette gray " >> toto.gplot
echo "set title '" $base "'" >> toto.gplot
echo "plot 'toto.rgb' binary array="$nx"x"$ny" flipy  format='%uchar%uchar%uchar%uchar%uchar%uchar' using (((\$2*256+\$1)*"$ga"+"$of")*100) with image" >>toto.gplot
