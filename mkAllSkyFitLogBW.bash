...
echo "set palette defined (  0 '"#000000"' ,  1 '"#222222"', 2 '"#444444"', 3 '"#666666"', 4 '"#888888"' , 5 '"#aaaaaa"' , 6 '"#cccccc"' ,7  '"#dddddd"',8 '"#FFFFFF"' )"  >> toto.gplot
...
#echo "unset surface" >> toto.gplot


echo "unset border" >> toto.gplot
echo "unset key" >> toto.gplot
echo "set zeroaxis lt -1" >> toto.gplot
echo "set xtics axis textcolor lt -1" >> toto.gplot
echo "set ytics axis textcolor lt -1" >> toto.gplot
echo "set border linetype -1" >> toto.gplot
...
echo "set arrow from 0,0 to 64,64 nohead lt -1 front" >> toto.gplot
echo "set arrow from 0,0 to 64,-64 nohead lt -1 front" >> toto.gplot
echo "set arrow from 0,0 to -64,-64 nohead lt -1 front" >> toto.gplot
echo "set arrow from 0,0 to -64,64 nohead lt -1 front" >> toto.gplot
...
gnuplot  < toto.gplot > $base"_BW.png"
# display $base".png" &
