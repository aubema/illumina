...
for layer in layers:
    for RH0 in RH_array:
        for wl in wavelengths:
            ...
            if (layer=='CC') | (layer=='CA') | (layer=='CP') | (layer=='U'):
                z1=8
                h1=2
                h2=2                   
            elif layer=='D':
            ...
            tau1=exta*z1*(1-np.exp(-h1/z1)) #aerosol layer 
            #tau2=extmin*z2*(np.exp(-h1/z2)-np.exp(-h2/z2)) #mineral/dust layer
            tau3=extft*z3*(np.exp(-h2/z3)-np.exp(-h3/z3)) #free troposhere
            tau4=extest*(h4-h3) #estratosphere
