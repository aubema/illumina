...
class Ui_ILLUMINA(object):
    def setupUi(self, ILLUMINA):
        ...
        self.box_band = QtWidgets.QComboBox(self.groupBox_3)
        ...
        self.box_band.addItem("")
        self.box_band.addItem("")
        self.box_band.addItem("")
        self.box_direction = QtWidgets.QLineEdit(self.groupBox_3)
        self.box_direction.setEnabled(True)
        ...
        self.box_direction.setDragEnabled(False)
        ...
        self.exp_def_button.setGeometry(QtCore.QRect(120, 630, 141, 25))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.Run_simulation.setGeometry(QtCore.QRect(310, 830, 141, 25))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.log_edit.setGeometry(QtCore.QRect(10, 660, 361, 161))
        self.log_edit.setObjectName("log_edit")
        self.progressBar = QtWidgets.QProgressBar(ILLUMINA)
        self.progressBar.setGeometry(QtCore.QRect(320, 860, 118, 23))
        ...
        self.Alt_esc = QtWidgets.QPushButton(ILLUMINA)
        self.Alt_esc.setEnabled(False)
        self.Alt_esc.setGeometry(QtCore.QRect(460, 630, 181, 25))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.Alt_esc.setFont(font)
        self.Alt_esc.setObjectName("Alt_esc")
        self.log_edit_2 = QtWidgets.QPlainTextEdit(ILLUMINA)
        self.log_edit_2.setGeometry(QtCore.QRect(380, 660, 361, 161))
        self.log_edit_2.setObjectName("log_edit_2")
        ...
        self.Alt_esc.raise_()
        self.log_edit_2.raise_()

        self.retranslateUi(ILLUMINA)
        QtCore.QMetaObject.connectSlotsByName(ILLUMINA)
        ILLUMINA.setTabOrder(self.name_edit, self.latitude_edit)
        ILLUMINA.setTabOrder(self.latitude_edit, self.longitude_edit)
        ILLUMINA.setTabOrder(self.longitude_edit, self.date_edit)
        ILLUMINA.setTabOrder(self.date_edit, self.altitude_edit)
        ILLUMINA.setTabOrder(self.altitude_edit, self.box_direction)
        ILLUMINA.setTabOrder(self.box_direction, self.box_band)
        ILLUMINA.setTabOrder(self.box_band, self.natural_light)
        ILLUMINA.setTabOrder(self.natural_light, self.comboBox_atm)
        ILLUMINA.setTabOrder(self.comboBox_atm, self.comboBox_rh)
        ILLUMINA.setTabOrder(self.comboBox_rh, self.aerosol_opac_button)
        ILLUMINA.setTabOrder(self.aerosol_opac_button, self.box_alpha)
        ILLUMINA.setTabOrder(self.box_alpha, self.box_aod)
        ILLUMINA.setTabOrder(self.box_aod, self.box_aeh)
        ILLUMINA.setTabOrder(self.box_aeh, self.perc_edit)
        ILLUMINA.setTabOrder(self.perc_edit, self.comboBox_tech)
        ILLUMINA.setTabOrder(self.comboBox_tech, self.comboBox_ulor)
        ILLUMINA.setTabOrder(self.comboBox_ulor, self.add_tech_btn)
        ILLUMINA.setTabOrder(self.add_tech_btn, self.clean_ls_btn)
        ILLUMINA.setTabOrder(self.clean_ls_btn, self.hlamp_edit)
        ILLUMINA.setTabOrder(self.hlamp_edit, self.obstacles_checkbox)
        ILLUMINA.setTabOrder(self.obstacles_checkbox, self.dobs_edit)
        ILLUMINA.setTabOrder(self.dobs_edit, self.hobs_edit)
        ILLUMINA.setTabOrder(self.hobs_edit, self.exp_def_button)
        ILLUMINA.setTabOrder(self.exp_def_button, self.Run_simulation)
        ILLUMINA.setTabOrder(self.Run_simulation, self.Alt_esc)
        ILLUMINA.setTabOrder(self.Alt_esc, self.log_edit_2)
        ILLUMINA.setTabOrder(self.log_edit_2, self.log_edit)
    ...
    def retranslateUi(self, ILLUMINA):
        ...
        self.box_band.setItemText(0, _translate("ILLUMINA", "V (J-C)"))
        self.box_band.setItemText(1, _translate("ILLUMINA", "TESS"))
        self.box_band.setItemText(2, _translate("ILLUMINA", "SG_WAS"))
        ...
        self.Alt_esc.setText(_translate("ILLUMINA", "8. Alternate Scenario"))
